...
public class OrderRecyclerViewAdapter extends RecyclerView.Adapter<OrderRecyclerViewAdapter.OrderHolder>{
    ...
    public void onBindViewHolder(@NonNull OrderHolder holder, int position) {
        ...
        if(Order.ORDER_STATUS_COMPLETED==status){
            ...
            holder.btnStatusChange.setText("COMPLETED");
            holder.btnStatusChange.setTextColor(0);
            ...
            holder.btnStatusChange.setText("Un-COMPLETED");
            holder.btnStatusChange.setTextColor(255);

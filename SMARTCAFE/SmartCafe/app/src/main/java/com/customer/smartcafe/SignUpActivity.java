...
public class SignUpActivity extends AppCompatActivity {
                ...
                .addOnSuccessListener(new OnSuccessListener<AuthResult>() {
                    ...
                    public void onSuccess(AuthResult authResult) {
                        ...
                        User user = new User(authResult.getUser().getUid().toString(),etName.getText().toString(),
                                etEmail.getText().toString(),etPassword.getText().toString(),etPhoneNo.getText().toString(),0);
    ...
    private void saveUserInDatabase(User user) {
        ...
        DatabaseReference userRef = FirebaseDatabase.getInstance().getReference(Constants.FIREBASE_CUSTOMER_DATABASE_REFERENCE).child(user.getId());

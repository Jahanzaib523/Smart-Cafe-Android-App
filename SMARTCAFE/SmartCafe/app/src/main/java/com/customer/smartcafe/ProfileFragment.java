...
public class ProfileFragment extends Fragment {
    ...
    private TextView tvName,tvEmail,tvPhoneNo,tvWallet;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        currCustomerDbRef = FirebaseDatabase.getInstance().getReference(Constants.FIREBASE_CUSTOMER_DATABASE_REFERENCE).child(currUser.getUid());
        ...
        currCustomerDbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                tvWallet.setText(user.getWallet()+"");
            }
